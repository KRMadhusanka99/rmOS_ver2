...
;************************************************************************************************
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to the ||rmOS _/o o\_|| Enter 'help' to dispaly menu", 0x00
	strPrompt		db	"Command>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"||rmOS _/o o\_||", 0x00	;OS details
	strMajorVer		db	"0", 0x00
	strMinorVer		db	".04", 0x00
	strTest			db	"Modified by Ramesh Madhusanka", 0x00
